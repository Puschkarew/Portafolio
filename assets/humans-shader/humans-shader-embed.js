  ...
  window.initHumansShader = function initHumansShader(rootElement, options) {
    ...
    rootElement.appendChild(canvas);
        ...
        const DEFAULTS = {
          RES_SCALE: 0.25,
          DPR_MAX: 1.0,
          POINTER_SMOOTHING: 0.02,
          BG_COLOR: "#3e120a",
          PARTICLE_CENTER_COLOR: "#ffc6ad",
          PARTICLE_EDGE_COLOR: "#ff3300",
          PARTICLE_RADIUS: 0.2,
          PARTICLE_SOFTNESS: 1.7,
          PARTICLE_EDGE_SMOOTHNESS: 4.0,
          PARTICLE_CONTOUR_NOISE: 0.0,
          PARTICLE_REVEAL_TIME: 1.5,
          PARTICLE_FADE_TIME: 3.0,
          ...
          SHATTER_MIX_INVERT: 1,
          BOKEH_RADIUS: 2.0,
          BOKEH_TILT: 1.0,
          BOKEH_MIX_RADIUS: 0.0,
        ...
        loadImage(ASSET_BASE + "orange-gradient.jpg", (img) => {
        ...
        loadImage(ASSET_BASE + "blue-noise.png", (img) => {
